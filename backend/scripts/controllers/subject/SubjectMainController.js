angular.module('app').controller('SubjectMainController', function($scope, $compile, $cookies, $filter, $state, $routeParams, HTTPService, IndexOverlayFactory) {
    ...
    $scope.loadList = function(condition){
        ...
        HTTPService.clientRequest('subject/list/manage', params).then(function(result){
            console.log(result);
