angular.module('app').controller('UserAccountTutorUpdateController', function($scope, $compile, $cookies, $filter, $state, $routeParams, HTTPService, IndexOverlayFactory) {
        ...
        HTTPService.clientRequest('user-account/update/tutor', params).then(function(result){
            ...
            if(result.data.STATUS == 'OK'){
                if(checkEmptyField($scope.Data.AutoID)){
                    // window.location.href = '#/user-account/tutor/update/' + result.data.DATA.AutoID;
                }else{
    ...
    $scope.goBack = function(){
        window.location.href = '#/user-account/tutor/';
    }
