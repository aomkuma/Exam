angular.module('app').controller('UserAccountAdminMainController', function($scope, $compile, $cookies, $filter, $state, $routeParams, HTTPService, IndexOverlayFactory) {
    ...
    $scope.loadList = function(condition){
        ...
        HTTPService.clientRequest('user-account/list/admin', params).then(function(result){
            console.log(result);
