angular.module('app').controller('ExamSourceMainController', function($scope, $compile, $cookies, $filter, $state, $routeParams, HTTPService, IndexOverlayFactory) {
    ...
    $scope.loadList = function(condition){
        ...
        HTTPService.clientRequest('exam-sources/list/manage', params).then(function(result){
            console.log(result);
