angular.module('app').controller('LevelMainController', function($scope, $compile, $cookies, $filter, $state, $routeParams, HTTPService, IndexOverlayFactory) {
    ...
    $scope.loadList = function(condition){
        ...
        HTTPService.clientRequest('level/list/manage', params).then(function(result){
            console.log(result);
