...
function makeSQLDateTime(dateObj){
  var m = ((dateObj.getMonth() + 1) < 10)?('0'+(dateObj.getMonth() + 1)):(dateObj.getMonth() + 1);  
  var d = dateObj.getDate() < 10?('0'+dateObj.getDate()):dateObj.getDate(); 
  var minutes = (dateObj.getMinutes() < 10?'0' + dateObj.getMinutes():dateObj.getMinutes());
  return dateObj.getFullYear() + '-' + m + '-' + d + ' ' + dateObj.getHours() + ':' + minutes + ':00';
}
...
function getMonthListTxt(){
    return [{'monthValue' : '01', 'monthText' : 'มกราคม'}
            , {'monthValue' : '02', 'monthText' : 'กุมภาพันธ์'}
            , {'monthValue' : '03', 'monthText' : 'มีนาคม'}
            , {'monthValue' : '04', 'monthText' : 'เมษายน'}
            , {'monthValue' : '05', 'monthText' : 'พฤษภาคม'}
            , {'monthValue' : '06', 'monthText' : 'มิถุนายน'}
            , {'monthValue' : '07', 'monthText' : 'กรกฎาคม'}
            , {'monthValue' : '08', 'monthText' : 'สิงหาคม'}
            , {'monthValue' : '09', 'monthText' : 'กันยายน'}
            , {'monthValue' : '10', 'monthText' : 'ตุลาคม'}
            , {'monthValue' : '11', 'monthText' : 'พฤศจิกายน'}
            , {'monthValue' : '12', 'monthText' : 'ธันวาคม'}
            ];
...
function getYearListTxt(loop)
{
    var curDate = new Date();
    var startYear = (curDate.getFullYear() + 543);
    var yearList = [];
    for(var i =0 ; i < loop; i++){
        var yValue = ''+(startYear - i);
        var year = yValue.substring(2);
        yearList.push({'yearValue': year, 'yearText' : startYear - i});
    }
    return yearList;
}
