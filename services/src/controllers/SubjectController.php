    ...
    class SubjectController extends Controller {
        ...
        public function getListManage($request, $response, $args){
            ...
            try{
                ...
                $Result = SubjectService::getListManage($condition , $currentPage, $limitRowPerPage);  
        ...
        public function getList($request, $response, $args){
            ...
            try{
                ...
                $DataList = SubjectService::getList();  
        ...
        public function getData($request, $response, $args){
            ...
            try{
                ...
                $Data = SubjectService::getData($AutoID);  
        ...
        public function updateData($request, $response, $args){
            ...
            try{
                ...
                $AutoID = SubjectService::updateData($Data);  
        ...
        public function deleteData($request, $response, $args){
            ...
            try{
                ...
                $result = SubjectService::removeData($AutoID);  
