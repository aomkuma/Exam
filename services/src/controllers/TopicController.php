    ...
    class TopicController extends Controller {
        ...
        public function getListManage($request, $response, $args){
            ...
            try{
                ...
                $ChapterID = $obj['obj']['ChapterID'];
                $condition = $obj['obj']['condition'];
                $currentPage = $obj['obj']['currentPage'];
                $limitRowPerPage = $obj['obj']['limitRowPerPage'];

                $Result = TopicService::getListManage($ChapterID, $condition , $currentPage, $limitRowPerPage);  
        ...
        public function getList($request, $response, $args){
            ...
            try{
                ...
                $DataList = TopicService::getList($ChapterID);  
        ...
        public function getData($request, $response, $args){
            ...
            try{
                ...
                $Data = TopicService::getData($AutoID);  
        ...
        public function updateData($request, $response, $args){
            ...
            try{
                ...
                $AutoID = TopicService::updateData($Data);  
        ...
        public function deleteData($request, $response, $args){
            ...
            try{
                ...
                $result = TopicService::removeData($AutoID);  
