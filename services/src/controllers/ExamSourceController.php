<?php
    ...
    use App\Service\ExamSourceService;

    class ExamSourceController extends Controller {
        ...
        public function getListManage($request, $response, $args){
            ...
            try{
                ...
                $Result = ExamSourceService::getListManage($condition , $currentPage, $limitRowPerPage);  
        ...
        public function getList($request, $response, $args){
            ...
            try{
                ...
                $DataList = ExamSourceService::getList();  
        ...
        public function getData($request, $response, $args){
            ...
            try{
                ...
                $Data = ExamSourceService::getData($AutoID);  
        ...
        public function updateData($request, $response, $args){
            ...
            try{
                ...
                $AutoID = ExamSourceService::updateData($Data);  
        ...
        public function deleteData($request, $response, $args){
            ...
            try{
                ...
                $result = ExamSourceService::removeData($AutoID);  
